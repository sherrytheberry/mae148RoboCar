...
# # FILE PATHS
# #
PATH_FILENAME = "donkey.csv"   # the path will be saved to this filename as comma separated x,y values
# Define the directory where you want to save the file
directory = "~/projects/mycar/data/"
# Expand the user's home directory in the path
directory = os.path.expanduser(directory)
# Define the filename
#filename = "donkey.csv"
# Concatenate the directory and filename to get the full path
path_filename = os.path.join(directory, PATH_FILENAME)
...
VESC_MAX_SPEED_PERCENT =.3 ## Max speed as a percent of actual max speed 
...
JOYSTICK_MAX_THROTTLE = 0.4         #this scalar is multiplied with the -1 to 1 throttle value to limit the maximum throttle. This can help if you drop the controller or just don't need the full speed available.
...
NETWORK_JS_SERVER_IP = "192.168.113.246"
#NETWORK_JS_SERVER_IP = "192.168.10.101"          #when listening for network joystick control, which ip is serving this information
...
AI_LAUNCH_DURATION = 4.0            # the ai will output throttle for this many seconds
AI_LAUNCH_THROTTLE = 0.1            # the ai will output this throttle value
...
# # PATH FOLLOWING
# #
#PATH_FILENAME = "donkey.txt"   # the path will be saved to this filename as comma separated x,y values
# Define the directory where you want to save the file
#directory = "~/projects/mycar/data/"
# Expand the user's home directory in the path
#directory = os.path.expanduser(directory)
...
PATH_SCALE = 1.0                   # the path display will be scaled by this factor in the web page
# PATH_OFFSET = (255, 255)            # 255, 255 is the center of the map. This offset controls where the origin is displayed.
PATH_MIN_DIST = 0.001                 # after travelling this distance (m), save a path point
...
PID_D = 0.17                    # differential mult for PID path follower
PID_THROTTLE = 0.3 #0.3                 # constant throttle value during path following
...
ERASE_PATH_BTN = "RT"     # button to erase path
...
# INC_PID_P_BTN = "RB"            # button to change PID 'P' constant by PID_P_DELTA
# DEC_PID_P_BTN = "LB"            # button to change PID 'P' constant by -PID_P_DELTA
# 
